// ============================================================================
// MY PHARMACY POS — demo database seed (clearly marked DEMO DATA)
// ============================================================================
import {
  ...
  addLedgerEntry, addCashEntry, WALKIN_ID, round2,
} from "./core";
...
export function buildSeed(): DB {
  const db: DB = {
    ...
    settings: {
      pharmacy: {
        name: "MY PHARMACY POS",
        address: "Shop #12, Main Bazaar Road, Lahore",
        phone: "+92 300 1234567",
        email: "info@mypharmacy.example",
      ...
      receipt: { paper: "80mm", copies: 1, header: "Store hours: Mon–Sat 9AM–10PM", footer: "Goods once sold are not returnable without receipt." },
      inventory: { expiryWarningDays: 30 },
  ...
  // ---- users ---------------------------------------------------------------
  db.users.push(
    { id: "u1", username: "admin", name: "Administrator", password: "admin123", role: "admin", active: true, mustChange: true, createdAt: todayISO() },
    { id: "u2", username: "manager", name: "Sara Ahmed", password: "manager123", role: "manager", active: true, mustChange: false, createdAt: todayISO() },
    { id: "u3", username: "cashier", name: "Bilal Khan", password: "cashier123", role: "cashier", active: true, mustChange: false, createdAt: todayISO() },
  );
  ...
  // ---- customers ------------------------------------------------------------
  db.customers.push(
    { id: WALKIN_ID, name: "Walk-in Customer", phone: "", address: "", email: "", creditLimit: 0, openingBalance: 0, balance: 0, notes: "Default cash customer", createdAt: todayISO() },
    { id: "c1", name: "Ali Hassan", phone: "+92 321 5555555", address: "Gulberg III, Lahore", email: "ali.h@example.com", creditLimit: 5000, openingBalance: 0, balance: 0, notes: "Credit customer", createdAt: todayISO() },
    { id: "c2", name: "Fatima Noor", phone: "+92 322 6666666", address: "DHA Phase 6", email: "", creditLimit: 3000, openingBalance: 0, balance: 0, notes: "", createdAt: todayISO() },
  );

  // ---- products -------------------------------------------------------------
  const cat = (name: string, sub: string, grp: string) => ({ category: name, subCategory: sub, group: grp });
  db.products.push(
    P({ name: "Panadol Extra 500mg", generic: "Paracetamol + Caffeine", brand: "GSK", barcode: "8961002001001", altBarcode: "PNE500", ...cat("Analgesics", "Pain Relief", "Tablets"), supplierId: "s1", unit: "Tab", purchasePrice: 45, retailPrice: 60, wholesalePrice: 52, avgCost: 45, minStock: 40, optStock: 120, maxStock: 300, location: "A1" }),
    P({ name: "Disprin 300mg", generic: "Aspirin", brand: "Reckitt", barcode: "8961002001002", ...cat("Analgesics", "Pain Relief", "Tablets"), supplierId: "s1", unit: "Tab", purchasePrice: 8, retailPrice: 12, wholesalePrice: 10, avgCost: 8, minStock: 50, optStock: 200, maxStock: 400, location: "A1" }),
    P({ name: "Brufen 400mg", generic: "Ibuprofen", brand: "Abbott", barcode: "8961002001003", ...cat("Analgesics", "Anti-inflammatory", "Tablets"), supplierId: "s2", unit: "Tab", purchasePrice: 30, retailPrice: 42, wholesalePrice: 36, avgCost: 30, minStock: 30, optStock: 100, maxStock: 250, location: "A2" }),
    P({ name: "Amoxil 250mg", generic: "Amoxicillin", brand: "GSK", barcode: "8961002001004", altBarcode: "AMX250", ...cat("Antibiotics", "Penicillins", "Capsules"), supplierId: "s1", unit: "Cap", purchasePrice: 55, retailPrice: 75, wholesalePrice: 64, avgCost: 55, control: true, minStock: 25, optStock: 80, maxStock: 200, location: "B1 (Cold)" }),
    P({ name: "Augmentin 625mg", generic: "Amoxicillin + Clavulanate", brand: "GSK", barcode: "8961002001005", ...cat("Antibiotics", "Penicillins", "Tablets"), supplierId: "s1", unit: "Tab", purchasePrice: 120, retailPrice: 160, wholesalePrice: 138, avgCost: 120, control: true, minStock: 20, optStock: 60, maxStock: 150, location: "B1" }),
    P({ name: "Zyrtec 10mg", generic: "Cetirizine", brand: "GSK", barcode: "8961002001006", ...cat("Antihistamines", "Allergy", "Tablets"), supplierId: "s2", unit: "Tab", purchasePrice: 35, retailPrice: 48, wholesalePrice: 41, avgCost: 35, minStock: 30, optStock: 90, maxStock: 220, location: "A3" }),
    P({ name: "Ventolin Inhaler 100mcg", generic: "Salbutamol", brand: "GSK", barcode: "8961002001007", ...cat("Respiratory", "Bronchodilators", "Inhalers"), supplierId: "s3", unit: "Pcs", purchasePrice: 380, retailPrice: 520, wholesalePrice: 450, avgCost: 380, minStock: 10, optStock: 25, maxStock: 60, location: "C2" }),
    P({ name: "Vitamin C 500mg", generic: "Ascorbic Acid", brand: "NutriPlus", barcode: "8961002001008", ...cat("Vitamins", "Supplements", "Tablets"), supplierId: "s4", unit: "Tab", purchasePrice: 15, retailPrice: 22, wholesalePrice: 18, avgCost: 15, minStock: 60, optStock: 200, maxStock: 500, location: "D1", seasonal: true }),
    P({ name: "ORS Sachet", generic: "Oral Rehydration Salts", brand: "Nestle", barcode: "8961002001009", ...cat("Gastro", "Rehydration", "Sachets"), supplierId: "s3", unit: "Sachet", purchasePrice: 6, retailPrice: 10, wholesalePrice: 8, avgCost: 6, minStock: 100, optStock: 300, maxStock: 800, location: "D2", seasonal: true }),
    P({ name: "Flagyl 400mg", generic: "Metronidazole", brand: "Sanofi", barcode: "8961002001010", ...cat("Antibiotics", "Antiprotozoals", "Tablets"), supplierId: "s2", unit: "Tab", purchasePrice: 25, retailPrice: 35, wholesalePrice: 30, avgCost: 25, minStock: 40, optStock: 120, maxStock: 300, location: "B2" }),
  );
  ...
  const pur1: Purchase = {
    ...
    subTotal: 0, discount: 0, loading: 0, freight: 0, other: 0, additional: 0, tax: 0, advanceTax: 0, withTax: 0, total: 0,
    status: "final", returned: false, userId: "u1", userName: "Administrator", createdAt: addDays(todayISO(), -5),
  };
  const pur2: Purchase = {
    ...
    subTotal: 0, discount: 0, loading: 0, freight: 0, other: 0, additional: 0, tax: 0, advanceTax: 0, withTax: 0, total: 0,
    status: "final", returned: false, userId: "u1", userName: "Administrator", createdAt: addDays(todayISO(), -2),
  };
  ...
  const addPurItem = (pur: Purchase, productId: string, batchIdx: number, qty: number, freeQty: number, cost: number, retail: number) => {
    ...
    const bt = b(batchIdx);
    const { discount, tax, total } = lineTotal(cost, qty, 0, 0);
    pur.items.push({
  ...
  const t1 = calcPurchaseTotals(pur1.items, 0, 0, 0, 0, 0, 0, 0, 0);
  ...
  const t2 = calcPurchaseTotals(pur2.items, 200, 150, 0, 0, 0, 0, 0, 0);
  ...
  const mkSaleItem = (productId: string, batchIdx: number, qty: number, rate?: number) => {
    ...
    return {
      ...
      rate: r, qty, discountPct: 0, taxPct, discount: 0, tax: 0, total: 0, cost: bt.cost,
    };
  };
  ...
  const buildSale = (
    ...
    const totals = calcSaleTotals(lines, 0, 0, 0, db.settings.tax.salesTaxPct);
    lines.forEach((l, i) => {
      const lt = lineTotal(l.rate, l.qty, 0, l.taxPct);
    ...
    const sale: Sale = {
      ...
      items: lines, gross: totals.gross, itemDisc: 0, receiptDiscPct: 0, receiptDisc: 0,
  ...
  db.saleReturns.push({
    ...
    method: "Credit", note: "Damaged blister", userId: "u3", userName: "Bilal Khan",
  });
  sYest.returned = true;
  ...
  db.audit.push(
    { id: uid(), date: addDays(T, -6), time: "09:00", userId: "u1", userName: "Administrator", action: "Install", detail: "Demo database created with sample data" },
